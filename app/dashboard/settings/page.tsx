...
import { Language } from "@/store/use-language-store";

export default function SettingsPage() {
  const { theme, switchTheme } = useThemeSwitch();
  const { lang, setLang, t, t_display, t_lang } = useTranslation();
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {themes.map((themeItem) => {
              ...
              return (
                <button
                  key={themeItem.id}
                  onClick={() => switchTheme(themeItem.id)}
                  className={cn(
                  ...
                  <div
                    className={cn(
                      ...
                      isActive
                        ...
                        : "opacity-40 scale-110 group-hover:opacity-70 group-hover:scale-100",
                    )}
                  />
                      ...
                      <>
                        <div
                          className={cn(
                            ...
                            isActive
                              ? "top-10 left-10 opacity-60 scale-100"
                              : "-top-10 -left-10 opacity-0 scale-50",
                          )}
                        />
                        <Sun
                          className={cn(
                            ...
                            isActive
                              ...
                              : "top-32 left-0 -rotate-90 opacity-0",
                          )}
                        />
                      ...
                      <>
                        ...
                        <div
                          className={cn(
                            ...
                            isActive
                              ? "bottom-10 right-10 opacity-100"
                        ...
                        <Moon
                          className={cn(
                            ...
                            isActive
                              ? "top-16 right-16 rotate-0"
                              : "top-0 right-0 rotate-45 opacity-0",
                          )}
                        />
                        {isActive &&
                          [1, 2, 3, 4, 5].map((i) => (
                        ...
                        <Monitor
                          className={cn(
                            ...
                            isActive
                              ...
                              : "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-50 -rotate-12 opacity-0",
                          )}
                        />
                        {isActive && (
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        {isActive ? (
                          ...
                          >
                            {t_display.switchTo} {themeItem.name}
                          </span>
                        )}
                      </div>
                    </div>
            ...
            {[
              ...
              <button
                ...
                onClick={() => {
                  ...
                  toast.success(`${t_lang.toast}: ${l.name}`, { icon: l.flag });
                }}
                className={cn(
              ...
              >
                <div className="relative z-10">
                  <span className="text-6xl group-hover:scale-125 group-hover:rotate-12 transition-transform duration-700 block drop-shadow-2xl">
                    {l.flag}
                  </span>
                </div>
                <div className="text-left relative z-10 flex-1">
                  <span
                    className={cn(
                      "block text-2xl font-black italic uppercase tracking-tighter leading-none mb-1",
